...
import com.example.hackathon.service.conversationService.IConversationService;
import com.example.hackathon.service.messageService.IMessageService;
...
public class ChatController {
    ...
    @PostMapping("/group")
    public ResponseEntity<?> createGroupChat(@RequestBody List<User> users){
    ...
    public ResponseEntity<List<User>> searchFriend(@PathVariable Long id, @RequestParam("q") String search){
    ...
    public ResponseEntity<List<User>> findAllMemberInConversation(@PathVariable Long id){
